        ...
        internetAvailable().then(function(){
                ...
                let results = Client.findAll({
                    ...
                    results.forEach(result => {
                        ...
                        .then(function (response){
                            ...
                            Client.update({ processed: "Processed", date_processed: DATE_TODAY, send_log: response.body.response.msg }, {
                                where: {
                                    id: result.id
                                }
                            });                            
                ...
                let results1 = Appointment.findAll({
                        ...
                        results.forEach(result => {
                            ...
                            .then(function (response){
                                ...
                                //update status of updated appointment
                                Appointment.update({ processed: "Processed", date_processed: DATE_TODAY, send_log: response.body.response.msg }, {
                                    where: {
                                        id: result.id
                                    }
                                });                            
                ...
                let results2 = ClientOru.findAll({
                    ...
                    results.forEach(result => {
                        ...
                        .then(function (response){
                            ...
                            //update status of updated appointment
                            ClientOru.update({ processed: "Processed", date_processed: DATE_TODAY, send_log: response.body.response.msg }, {
                                where: {
                                    id: result.id
                                }
                            });                            
            ...
            request(options, function (error, response, body) {
                ...
                if (error) {
                    ...
                    let s = response.body.response.errors[0].instance;
